...
|---|---|:--:|
| `01_calibration_quickstart.ipynb` | End-to-end Rayleigh calibration of one night: load options, define the instrument, run `calibrate_rayleigh`, read the result; plus CLI / batch usage | yes (L1/L2 + CAMS) |
